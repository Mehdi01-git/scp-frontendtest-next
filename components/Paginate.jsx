...
function EnhancedTableToolbar(props) {
  const { numSelected, absences } = props;
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          Absences {absences !== null && `(${absences.payload.length})`}
        </Typography>
      )}
    </Toolbar>
  );
...
export default function EnhancedTable({ members, absences }) {
  ...
  const rows =
    absences !== null &&
    absences.payload.map((absence, i) => {
      return createData(
        i,
          ...
          >
            ...
            <TableBody className="tableBody">
              {rows.length > 10 ? (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          <Tooltip title="Download iCal file">
                            ...
                            >
                              <FiDownload className="downButton" />
                            </button>
                          </Tooltip>
                        </TableCell>
                        <TableCell></TableCell>
                ...
                >
                  <TableCell className="loader-container">
                    <h1>No Absences</h1>
                  </TableCell>
                </TableRow>
              ) : rows === null ? (
